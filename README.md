...
Руководства по стилю (за небольшими исключениями) скопированы с внутренних документов Google
 с целью помочь разработчикам работать над проектами Google или проектами с открытым исходным
 кодом. Как результат, изменения в руководствах по стилю делаются сначала во внутренних
 документах, потом изменения копируются во внешний документ. **Внешнее участие не допускается**.
 Pull request обычно закрываются без объяснения причин. Допустимо
 [зарегистрировать проблему в трекере GitHub][gh-tracker]. Очевидные ошибки или технические
 неточности теоретически могут быть приняты, однако в любом случае документы изменяются с
 учётом внутреннего применения в Google.
